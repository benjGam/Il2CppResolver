...
/// The exception object remains owned by the target runtime; this exception exposes only its remote identity and does not attempt to marshal the managed exception object.
/// </summary>
public sealed class Il2CppInvocationException : Exception
{
    /// <summary>Gets the remote <c>Il2CppException*</c> address reported by the target runtime.</summary>
